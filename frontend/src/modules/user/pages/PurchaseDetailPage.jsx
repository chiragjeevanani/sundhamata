      ...
      <Header
        ...
        rightAction={
          purchase && (
            <button
              onClick={handleShare}
              className="w-7 h-7 rounded-full bg-stone-50 hover:bg-stone-100 border border-stone-200/80 flex items-center justify-center text-stone-700 transition-colors cursor-pointer"
              aria-label="Share Purchase"
            >
              {copiedKey === 'share' ? (
                <Check className="w-3.5 h-3.5 text-emerald-600" />
              ) : (
                <Share2 className="w-3.5 h-3.5 text-ink-900" />
              )}
            </button>
          )
        }
      ...
      <div className="p-3.5 sm:p-4 space-y-2.5">
        {loading ? (
          ...
          <>
            ...
            <div className="bg-white rounded-2xl p-3 sm:p-3.5 border border-stone-200/90 shadow-[0_1px_2px_rgba(15,32,66,0.03)] flex flex-col gap-2.5">
              <div className="flex gap-3 items-center">
                {/* Product Photography Container */}
                <div className="w-18 h-22 rounded-xl bg-stone-50 border border-stone-100 p-1 shrink-0 flex items-center justify-center overflow-hidden">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <h2 className="text-[14.5px] sm:text-base font-black text-ink-900 tracking-tight leading-snug">
              ...
              <div className="pt-2 border-t border-stone-100 flex items-center justify-between">
                <div>
                  <span className="text-[9px] uppercase font-bold text-stone-400 tracking-wider block leading-none">
                    Amount Paid
                  </span>
                  <span className="text-[15px] font-extrabold text-ink-900 font-mono tabular-nums leading-tight mt-0.5 block">
                ...
                <div className="text-right">
                  ...
                  <span className="text-[11.5px] font-bold text-stone-700 leading-tight mt-0.5 block">
            ...
            <div className="bg-white rounded-xl p-3 border border-stone-200/90 shadow-[0_1px_2px_rgba(15,32,66,0.03)] space-y-1.5">
              ...
              <div className="space-y-1 text-xs divide-y divide-stone-100">
                <div className="flex items-center justify-between gap-3 pt-0.5">
                  <span className="text-stone-500 font-medium shrink-0">Brand</span>
                  <span className="font-semibold text-stone-900 text-right break-words">{purchase.product.brand || '—'}</span>
                </div>

                <div className="flex items-center justify-between gap-3 pt-1">
                  <span className="text-stone-500 font-medium shrink-0">Model</span>
                  <span className="font-semibold text-stone-900 text-right break-words">{purchase.product.model || purchase.product.name}</span>
                </div>

                <div className="flex items-center justify-between gap-3 pt-1">
                  <span className="text-stone-500 font-medium shrink-0">Variant</span>
                  <span className="font-semibold text-stone-900 text-right break-words">{purchase.product.variant || '—'}</span>
                </div>

                <div className="flex items-center justify-between gap-3 pt-1">
                  <span className="text-stone-500 font-medium shrink-0">Colour</span>
                  <span className="font-semibold text-stone-900 text-right break-words">{purchase.product.color || '—'}</span>
                </div>

                {/* IMEI or serial number, with copy */}
                {(purchase.product.imei || purchase.product.serialNumber) && (
                  <div className="flex items-center justify-between pt-1">
                    <span className="text-stone-500 font-medium">IMEI / SN</span>
                    <div className="flex items-center gap-1">
                      ...
                      <button
                        ...
                        className="p-0.5 text-stone-400 hover:text-brand-700 transition-colors cursor-pointer"
            ...
            <div className="bg-white rounded-xl p-3 border border-stone-200/90 shadow-[0_1px_2px_rgba(15,32,66,0.03)] space-y-1.5">
              ...
              <div className="space-y-1 text-xs divide-y divide-stone-100">
                <div className="flex items-center justify-between pt-0.5">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <button
                      ...
                      className="p-0.5 text-stone-400 hover:text-brand-700 cursor-pointer"
                    >
                      {copiedKey === 'invoice' ? (
                ...
                <div className="flex items-center justify-between pt-1">
                  <span className="text-stone-500 font-medium">Purchase Date</span>
                ...
                {purchase.loyalty?.pointsEarned > 0 && (
                  <div className="flex items-center justify-between pt-1">
                    <span className="text-stone-500 font-medium">Points Earned</span>
            ...
            {purchase.warranty && (
              <div className="bg-white rounded-xl p-3 border border-stone-200/90 shadow-[0_1px_2px_rgba(15,32,66,0.03)] space-y-1.5">
                <div className="flex items-center justify-between pb-1 border-b border-stone-100">
                  <h3 className="text-[11px] font-bold uppercase tracking-wider text-ink-900 flex items-center gap-1.5">
            ...
            <div className="bg-white rounded-xl p-3 border border-stone-200/90 shadow-[0_1px_2px_rgba(15,32,66,0.03)] space-y-1.5">
              ...
              <div className="flex items-start justify-between gap-3 text-xs">
                <div>
                  <h4 className="font-bold text-ink-900 leading-tight">
                    {store?.name}
                  </h4>
