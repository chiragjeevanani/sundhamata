...
export const PurchaseCardSkeleton = () => (
  <div className="bg-white rounded-xl p-3 border border-slate-200/80 shadow-2xs animate-pulse">
    {/* Top meta skeleton */}
    ...
    <div className="flex items-center gap-3">
      <div className="w-14 h-16 bg-slate-100 rounded-lg shrink-0" />
...
export const HomeSkeleton = () => (
  <div className="space-y-3 animate-pulse">
    ...
    <div className="grid grid-cols-2 gap-2.5">
      <div className="bg-white rounded-xl p-3 border border-slate-200/80 h-16" />
      <div className="bg-white rounded-xl p-3 border border-slate-200/80 h-16" />
    </div>
    ...
    <div className="space-y-1.5">
      ...
      <div className="bg-[#0F2042] rounded-xl p-3.5 h-32 opacity-80" />
    </div>
...
export const PurchaseDetailSkeleton = () => (
  <div className="space-y-2.5 animate-pulse">
    ...
    <div className="bg-white rounded-2xl p-3.5 border border-slate-200 flex gap-3 items-center">
      <div className="w-18 h-22 bg-slate-100 rounded-xl shrink-0" />
    ...
    <div className="bg-white rounded-xl p-3 border border-slate-200 space-y-2">
      <div className="h-2.5 bg-slate-200 rounded w-24 pb-1" />
...
export const LoyaltySkeleton = () => (
  <div className="space-y-3 animate-pulse">
    ...
    <div className="bg-[#0F2042] rounded-2xl p-4 h-36 opacity-85" />

    {/* 3-column month summary skeleton */}
    <div className="bg-white rounded-xl p-3 h-16 border border-slate-200/80 flex justify-around items-center" />

    {/* Earning methods skeleton */}
    <div className="space-y-2 pt-1">
      <div className="h-3 bg-slate-200 rounded w-32" />
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
        <div className="bg-white rounded-xl p-3 h-16 border border-slate-200/80" />
        <div className="bg-white rounded-xl p-3 h-16 border border-slate-200/80" />
        <div className="bg-white rounded-xl p-3 h-16 border border-slate-200/80" />
      </div>
    </div>
    ...
    <div className="space-y-2 pt-1">
      ...
      <div className="bg-white rounded-xl p-3 h-14 border border-slate-200/80" />
      <div className="bg-white rounded-xl p-3 h-14 border border-slate-200/80" />
    </div>
  </div>
);
