...
export const PurchaseCard = ({ purchase }) => {
  ...
  return (
    <motion.div
      ...
      className="group bg-white rounded-xl border border-stone-200/90 shadow-[0_1px_2px_rgba(15,32,66,0.03)] hover:border-stone-300 hover:shadow-[0_2px_8px_rgba(15,32,66,0.05)] transition-all cursor-pointer p-3 flex items-center gap-3"
    >
      {/* Product Image */}
      <div className="w-13 h-15 rounded-lg bg-stone-50 border border-stone-100 p-1 shrink-0 flex items-center justify-center overflow-hidden">
      ...
      <div className="flex-1 min-w-0">
        <h4 className="text-[13.5px] font-bold text-stone-900 tracking-tight leading-snug truncate group-hover:text-brand-700 transition-colors">
          {product.name}
        </h4>
      ...
      <div className="text-right shrink-0 flex flex-col items-end gap-1.5 pl-2">
        <span className="text-[14px] font-extrabold text-ink-900 font-mono tabular-nums leading-none">
          {formatINR(amount)}
        </span>
